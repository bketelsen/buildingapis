...
func CreateRegistrationBadRequest(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.RegistrationController, payload *app.CreateRegistrationPayload) (http.ResponseWriter, *goa.Error) {
	...
	u := &url.URL{
		Path: fmt.Sprintf("/registrations"),
	}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListRegistrationOK(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.RegistrationController) (http.ResponseWriter, app.RegistrationMediaCollection) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowRegistrationBadRequest(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.RegistrationController, id int) (http.ResponseWriter, *goa.Error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	rw := httptest.NewRecorder()
	u := &url.URL{
		Path: fmt.Sprintf("/registrations/%v", id),
	}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		panic("invalid test " + err.Error()) // bug
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowRegistrationNotFound(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.RegistrationController, id int) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowRegistrationOK(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.RegistrationController, id int) (http.ResponseWriter, *app.RegistrationMedia) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
