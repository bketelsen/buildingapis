...
// CreateCourseBadRequest Create runs the method Create of the given controller with the given parameters and payload.
...
func CreateCourseBadRequest(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.CourseController, payload *app.CreateCoursePayload) (http.ResponseWriter, *goa.Error) {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "CourseTest"), rw, req, prms)
	createCtx, err := app.NewCreateCourseContext(goaCtx, service)
	if err != nil {
...
// CreateCourseCreated Create runs the method Create of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func CreateCourseCreated(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.CourseController, payload *app.CreateCoursePayload) (http.ResponseWriter, *app.CourseMedia) {
	...
	var mt *app.CourseMedia
	if resp != nil {
		var ok bool
		mt, ok = resp.(*app.CourseMedia)
		if !ok {
			t.Errorf("invalid response media: got %+v, expected instance of app.CourseMedia", resp)
		}
		err = mt.Validate()
		if err != nil {
...
// CreateCourseCreatedLink Create runs the method Create of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func CreateCourseCreatedLink(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.CourseController, payload *app.CreateCoursePayload) (http.ResponseWriter, *app.CourseMediaLink) {
	...
	var mt *app.CourseMediaLink
	if resp != nil {
		var ok bool
		mt, ok = resp.(*app.CourseMediaLink)
		if !ok {
			t.Errorf("invalid response media: got %+v, expected instance of app.CourseMediaLink", resp)
		}
		err = mt.Validate()
		if err != nil {
			t.Errorf("invalid response media type: %s", err)
...
// CreateCourseUnauthorized Create runs the method Create of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
...
// DeleteCourseNoContent Delete runs the method Delete of the given controller with the given parameters.
...
func DeleteCourseNoContent(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.CourseController, id int) http.ResponseWriter {
	...
	rw := httptest.NewRecorder()
	u := &url.URL{
		Path: fmt.Sprintf("/api/courses/%v", id),
	}
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "CourseTest"), rw, req, prms)
	deleteCtx, err := app.NewDeleteCourseContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
...
// DeleteCourseNotFound Delete runs the method Delete of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
...
func ListCourseOK(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.CourseController, name *string) (http.ResponseWriter, app.CourseMediaCollection) {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "CourseTest"), rw, req, prms)
	listCtx, err := app.NewListCourseContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
	...
	var mt app.CourseMediaCollection
	if resp != nil {
		var ok bool
		mt, ok = resp.(app.CourseMediaCollection)
		if !ok {
			t.Errorf("invalid response media: got %+v, expected instance of app.CourseMediaCollection", resp)
		}
		err = mt.Validate()
		if err != nil {
			t.Errorf("invalid response media type: %s", err)
...
// ListCourseOKLink List runs the method List of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListCourseOKLink(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.CourseController, name *string) (http.ResponseWriter, app.CourseMediaLinkCollection) {
	...
	var mt app.CourseMediaLinkCollection
	if resp != nil {
		var ok bool
		mt, ok = resp.(app.CourseMediaLinkCollection)
		if !ok {
			t.Errorf("invalid response media: got %+v, expected instance of app.CourseMediaLinkCollection", resp)
		}
		err = mt.Validate()
		if err != nil {
			t.Errorf("invalid response media type: %s", err)
...
// PatchCourseBadRequest Patch runs the method Patch of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func PatchCourseBadRequest(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.CourseController, id int, payload *app.PatchCoursePayload) (http.ResponseWriter, *goa.Error) {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "CourseTest"), rw, req, prms)
	patchCtx, err := app.NewPatchCourseContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
...
// PatchCourseNoContent Patch runs the method Patch of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
...
// PatchCourseNotFound Patch runs the method Patch of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
...
// PatchCourseUnauthorized Patch runs the method Patch of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
...
func ShowCourseBadRequest(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.CourseController, id int) (http.ResponseWriter, *goa.Error) {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "CourseTest"), rw, req, prms)
	showCtx, err := app.NewShowCourseContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
...
// ShowCourseNotFound Show runs the method Show of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
